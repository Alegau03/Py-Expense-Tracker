...
def main(page: ft.Page):
    ...
    page.padding = 0
    page.spacing = 0
    page.title = "EXPENSE TRACKER Python v1.1.4"
    ...
    def home_page():
        ...
        def conferma_spesa(e):
            ...
            if conto_trovato:
                ...
                dlg_modal.actions[1].value = "Conto NON500 trovato"
                page.update()
        ...
        def aggiorna_saldo_conto_spesa(nome_conto, importo):
            ...
            with open('assets/conti.csv', 'r', encoding="utf8") as conti_file:
            ...
            with open('assets/conti.csv', 'w', newline='', encoding="utf8") as conti_file:
        ...
        def calcola_entrata_totale():
            totale = 0
            with open('assets/entrate.csv', 'r',encoding="utf8") as file:
                reader = csv.reader(file)
                for row in reader:
                    totale += float(row[0])
            return totale
...
#########################àSTRUTTURA PAGINA###############################
        ...
        page.add(ft.Card( 
            ...
            content=ft.Container(
                ...
                ), width= 300,padding=15,margin=10,border_radius=10
            )
        ))
        ...
        page.add(ft.Card(
            content=ft.Container(
                content=ft.Column(
                        ...
                        ft.Row(
                             [ft.ElevatedButton(text="Aggiungi Spesa", on_click=aggiungi_spesa,bgcolor=ft.colors.DEEP_ORANGE_ACCENT_700,color="white",width=150),
                              ft.ElevatedButton(text="Aggiungi Entrata", on_click=entrata,color="white",bgcolor=ft.colors.DEEP_ORANGE_ACCENT_700,width=160)], 
                             
                        )
                    ]
                ), width=350,padding=7,margin=5,border_radius=10
            )
        ))
        ...
        page.add(ft.Container(
            content=spesaTot,
            bgcolor=ft.colors.RED_ACCENT_700,padding=5,margin=10,gradient=ft.LinearGradient(
                begin=ft.alignment.top_left,end=ft.alignment.bottom_right,colors=[ft.colors.DEEP_ORANGE_900,ft.colors.DEEP_PURPLE_ACCENT_700]
            ),border_radius=5
        ...
        page.add(ft.Container(
            content=entrataTot,
            bgcolor=ft.colors.RED_ACCENT_700,padding=5,margin=10,gradient=ft.LinearGradient(
                begin=ft.alignment.top_left,end=ft.alignment.bottom_right,colors=[ft.colors.DEEP_PURPLE_ACCENT_700,ft.colors.DEEP_ORANGE_900]
            ),border_radius=5

        ))
        #BOTTONE PER AZZERARE SPESE
        page.add(ft.ElevatedButton(text="Azzera Spesa", on_click=azzera_spesa_totale))
        page.add(ft.Container(
                    content=ft.ElevatedButton(text="Aggiungi Conto", on_click=aggiungi_conto,bgcolor=ft.colors.DEEP_ORANGE_ACCENT_700,color="white"),
                    margin=5,
                    padding=5,
    ...
    def altro_page():
        ...
        def crea_istogramma(file_spese, file_entrate, anno_corrente):
            ...
            plt.savefig(f'images/istogramma_{anno_corrente}.jpg', dpi=350, pad_inches=0.1, bbox_inches="tight")
            plt.clf()
            plt.close()
        page.clean()
        ...
        page.add(ft.Text("Grafici",weight="bold",size=30))
        page.add(ft.Text("Seleziona le due date di intervallo"))
        ...
        crea_grafici_button = ft.FilledButton("Crea Grafici", on_click=crea_grafici)
    ...
    def conti_page():
            ...
            def modifica_conto(e):
                ...
                if nuovo_saldo == "" or nuovo_saldo == " " or nuovo_saldo == None:
                    ...
                    if conto_da_modificare is not None:
                        ...
                        with open(file_path_conti, 'w', newline='', encoding='utf-8') as conti_file:
                            conti_writer = csv.writer(conti_file)
                        ...
                        if saldo_precedente > nuovo_saldo:
                            ...
                            with open(file_path_spese, 'a', newline='', encoding='utf-8') as spese_file:
                            ...
                            with open(file_path_entrate, 'a', newline='', encoding='utf-8') as entrate_file:
            ...
            colonna1=ft.Column([
                ft.Container(
                    content=ft.Text("Gestione Conti",weight="bold",font_family="sans-serif",size=30),
                    margin=10,
                    padding=10,
                    alignment=ft.alignment.center,
                    border_radius=10),
                ...
                ft.Container(content=ft.Row([ft.FloatingActionButton(text="Modifica",width=70,bgcolor=ft.colors.DEEP_ORANGE_ACCENT_400,on_click=open_modifica_dialog),
                        ft.FloatingActionButton(text="Elimina",width=70,bgcolor=ft.colors.RED_900,on_click=open_elimina_dialog)]),alignment=ft.alignment.center,margin=10,border_radius=7)
                ])
    ...
    page.appbar = ft.AppBar(
        ...
        title=ft.Text("EXPENSE TRACKER", color=ft.colors.RED_ACCENT_700, size=15, weight=ft.FontWeight.W_900),
        center_title=True,
        bgcolor='#394145',
        actions=[
